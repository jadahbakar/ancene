        ...
        <div className="container mx-auto items-center flex flex-wrap">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              ...
              {/* <h2 className="text-blueGray-600">
                <div className="text-5xl  font-ancene">
                  Ancene
                </div>
              ...
              <img
                className="absolute top-0 b-auto right-15 w-17 md:w-32 lg:w-17"
                src="/img/brand/ancene-logo.png"
                alt="..."
              />
              
              <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                Ancene brings people to shifting the need of reliable .... {" "}
                <a
                ...
                . and we hope it could help other to deliver bullet proven application.
              </p>
              <div className="mt-12">
                <a
